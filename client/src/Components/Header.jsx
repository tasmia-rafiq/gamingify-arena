...
const Header = () => {
  ...
  useEffect(() => {
    fetch("https://gamingify-arena-api.vercel.app/api/profile", {
      credentials: "include",
    }).then((response) => {
  ...
  useEffect(() => {
    // Fetch categories
    fetch("https://gamingify-arena-api.vercel.app/api/category")
  ...
  function logout() {
    fetch("https://gamingify-arena-api.vercel.app/api/logout", {
      credentials: "include",
      method: "POST",
    });
    setUserInfo(null);
